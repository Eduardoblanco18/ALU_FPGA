...
entity adder_4_bits is	--criação das entradas e saídas do circuito
		port (
...
architecture bhv_add_4_bits of adder_4_bits is --criação dos sinais que serâo utilizados no circuito
		signal CARRY_IN: std_logic;
		signal A_int, B_int, CARRY_OUT, SUM: std_logic_vector (3 downto 0);
		
		begin 	--atribui as entradas a seus respectivos sinais
		A_int <= a;
		B_int <= b;
		CARRY_IN <= cin;
			--"joga" esses sinais no circuito full_adder como valores de entrada e recebe de volta os respectivos carry out's e somas
		...
		cout<=CARRY_OUT(3);
		--circuito que retorna o overflow
